...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~0d23968f3f794611621aa3a63ea527cd:6b446a4551684d58684f553d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'Dark;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,!',
    STICKER_DATA: process.env.STICKER_DATA || "•⏤⵿༄ 𝆺𝅥⃝⃪⃜❤️ᴄ͢͢͢ʀɪᴍɪɴᴀʟ𓆪ꪾ❦︎ 𝆺𝅥⃝🍷",
    BOT_NAME: process.env.BOT_NAME || '•─⃜͢🇮🇳⃝⃨ ̵⃡ ᴊᴀᴄᴋ sᴘʏاا̽ـ꯭❤',
    ...
    SUDO: process.env.SUDO || "923553257073,33757051153919630863919,018827062791",
